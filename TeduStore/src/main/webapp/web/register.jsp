    ...
    if(lengths==5){
    	$.ajax({
    		...
    		success:function(obj){
    			if(obj.state==0){
    				$("unamespan").text(obj.message).attr("class","msg-error");
    			}else{
     ...
     $.ajax({
    	...
    	success:function(obj){
    		if(obj.state==0){
    			...
    			$("#unamespan").text(obj.message).attr("class","msg-success");
    		}
    	}
     });
    }
  ...
  email.onblur = function(){
    if(this.validity.valueMissing){
      ...
      $.ajax({
    	  ...
    	  success:function(obj){
    		  if(obj.state==0){
    			  $("#emailspan").text(obj.message).attr("class","msg-error");
    		  }else{
    			  $("#emailspan").text(obj.message).attr("class","msg-success");
    		  }
    	  }
      });
    }
    ...
    if(this.validity.valueMissing){
     ...
     $.ajax({
    	 ...
    	 success:function(obj){
    		 if(obj.state==0){
    			 //不可以使用则背景为红色
    			 $("#phonespan").text(obj.message).attr("class","msg-error");
    		 }else{
    			 //可以使用则背景为绿色
    			 $("#phonespan").text(obj.message).attr("class","msg-success");
    		 }
    	 }
     });
    }
