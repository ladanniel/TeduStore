...
<div id="container" class="clearfix">
    ...
    <div class="rightsidebar_box rt">
        <div class="rs_header">
            <span class="rs_header_active"><a href="${pageContext.request.contextPath}/user/showPersonpage.do">我的信息</a></span>
		...
		$.ajax({
			...
			success:function(obj){
				if(obj.state==0){
					...
					//alert(obj.message);
					//刷新页面
					location="${pageContext.request.contextPath}/user/showPersonpage.do";
				}
			}
		});
	}
