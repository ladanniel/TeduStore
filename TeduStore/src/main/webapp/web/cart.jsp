                ...
                <div class="imfor">
                    ...
                    <div class="pudc">
                        <div class="pudc_information" id="${goods.id}">
                            <img src="..${goods.image}" class="lf" style="width:84px;height:84px;"/>
                            <input type="hidden" name="" value="">
                        <span class="des lf">
                           ${goods.title}
                              <input type="hidden" name="" value="">
                    ...
                    <div class="pices">
                        ...
                        <p class="pices_information"><b>￥</b><span>${goods.price}.00  <input type="hidden" name="" value=""></span></p>
                    </div>
                    <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text" value="${goods.num}" ><span class="add">&nbsp;+&nbsp;</span></div>
                    <div class="totle">
                        <span>￥</span>
                        <span class="totle_information">${goods.price*goods.num}.00</span>
                    </div>
                    <div class="del">
                        <!-- <div>
